...
router.post('/dashboard/reset-password', auth(USER_ROLES.ADMIN, USER_ROLES.ARTIST,USER_ROLES.INVESTOR), validateRequest(AuthValidation.createResetPasswordZodSchema), AuthController.resetPasswordByUrl);

router.post('/change-password', auth(USER_ROLES.ADMIN, USER_ROLES.ARTIST,USER_ROLES.INVESTOR), validateRequest(AuthValidation.createChangePasswordZodSchema), AuthController.changePassword);
